...
DB_PATH = '2_base_datos_objeto_currency.db'
...
class CurrencyManager(object):
    ...
    def get(self, code):
        ...
        if not data:
            raise CurrencyDoesNotExists("No existe la moneda de código {}".format(code))
...
peso_uru = Currency(code='UYU', name = 'Peso Uruguayo', symbol = '$ UYU')
